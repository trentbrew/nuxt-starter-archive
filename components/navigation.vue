  ...
  <div class="navbar bg-base-100 rounded-xl">
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal p-0">
        <li>
          <NuxtLink :class="route.name == 'index' && 'active'" to="/">Home</NuxtLink>
        </li>
        <li>
          <NuxtLink :class="route.name == 'dashboard' && 'active'" to="/dashboard">Dashboard</NuxtLink>
        </li>
        <li>
          <NuxtLink :class="route.name == 'about' && 'active'" to="/about">About</NuxtLink>
        </li>
      </ul>
    </div>
    <div class="navbar-end">
      <button class="btn bg-transparent border-none hover:bg-transparent hover:rotate-90">
        <svg class="h-1 w-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          viewBox="0 0 24 24">
          <path
